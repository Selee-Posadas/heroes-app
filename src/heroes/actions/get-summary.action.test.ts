...
describe("getSummaryAction", () => {
  test("Should fetch summary and return complete information", async () => {
    ...
    // console.log(summary);
    //Usamos objectContaining para ser resilientes a cambios futuros del backend
    expect(summary).toStrictEqual({
      totalHeroes: expect.any(Number),
      // Evaluamos que los objetos internos tengan la estructura necesaria
      strongestHero: expect.objectContaining({
        ...
        // Si el backend quita 'universe', este test fallaría aquí
        // porque lo estamos pidiendo explícitamente.
